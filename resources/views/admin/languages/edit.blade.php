                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form method="POST" class="form"  action="../update/{{$language->id}}">
                                            @csrf
                                            <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="diraction" class="select2 form-control">
                                                                <optgroup label="من فضلك أختر اتجاه اللغة ">
                                                                    <option value="rtl" @if($language->diraction == 'rtl' ) selected @endif>من اليمين الي اليسار</option>
                                                                    <option value="ltr" @if($language->diraction == 'ltr') selected @endif>من اليسار الي اليمين</option>
                                                                </optgroup>
                                                            </select>
                                                            @error('diraction')
                                                            <span class="text-danger">{{$message}}</span>
