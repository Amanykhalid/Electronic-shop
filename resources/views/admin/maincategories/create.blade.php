                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form"  method="POST" action="{{route('admin.maincategories.store')}}"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label> اسم القسم - {{__('massages.'.$lang->abbr)}} </label>
                                                        <input type="text"
                                                               class="form-control"
                                                               placeholder=""
                                                ...
                                                <div class="col-md-6 hidden">
                                                    <div class="form-group">
                                                        <label> أختصار اللغة - {{__('massages.'.$lang->abbr)}} </label>
                                                        <input type="text"
                                                               value="{{$lang->abbr}}"
                                                               class="form-control"
                                                               placeholder=""
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mt-1">
                                                        ...
                                                        <label for="switcheryColor4"
                                                               class="card-title ml-1">الحالة - {{__('massages.'.$lang->abbr)}}</label>
