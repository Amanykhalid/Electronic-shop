                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> اسم القسم
                                                                - {{__('massages.'.$mainCategory ->translation_lang)}} </label>
                                                     ...
                                                     <div class="col-md-6 hidden">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> أختصار
                                                                اللغة {{__('massages.'.$mainCategory ->translation_lang)}} </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            ...
                                                            <label for="switcheryColor4"
                                                                   class="card-title ml-1">الحالة {{__('massages.'.$mainCategory->translation_lang)}} </label>
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> اسم القسم
                                                                        - {{__('massages.'.$translation ->translation_lang)}} </label>
                                                                    <input type="text" id="name"
                                                                           class="form-control"
                                                                           placeholder="  "
                                                            ...
                                                            <div class="col-md-6 hidden">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> أختصار
                                                                        اللغة {{__('massages.'.$translation ->translation_lang)}} </label>
                                                                    <input type="text" id="abbr"
                                                                           class="form-control"
                                                                           placeholder="  "
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group mt-1">
                                                                    ...
                                                                    <label for="switcheryColor4"
                                                                           class="card-title ml-1">الحالة {{__('massages.'.$translation ->translation_lang)}} </label>
