...
@section('script')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCeGQNRs4qipF1zRfcNfT4Sdtru8AMu6eE&libraries=places&callback=initAutocomplete&language=ar&region=PA
         async defer"></script>
    @stop